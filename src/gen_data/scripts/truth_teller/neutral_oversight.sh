#!/bin/bash
#SBATCH --job-name=truth_teller_neutral
...
export path_to_class_def=distribution_definitions/truth_teller.py 
export distribution_class_name=TruthTellerNeutralOversight
export dir_to_output_data=data/truth_teller/neutral_oversight
source scl_source enable devtoolset-10

mpirun --allow-run-as-root --oversubscribe -np 4 python gen_utils/generate_examples.py \

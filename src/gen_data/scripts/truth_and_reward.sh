#!/bin/bash
#SBATCH --job-name=truth_and_reward
...
export path_to_class_def=distribution_definitions/truth_and_reward.py 
export distribution_class_name=TruthReward
export dir_to_output_data=data/truth_and_reward

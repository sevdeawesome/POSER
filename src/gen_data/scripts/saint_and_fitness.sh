#!/bin/bash
#SBATCH --job-name=saint_and_fitness
...
export path_to_class_def=distribution_definitions/saint_and_fitness.py 
export distribution_class_name=SaintFitnessMaximizer
export dir_to_output_data=data/saint_and_fitness

#!/bin/bash
#SBATCH --job-name=saint_and_reward
...
export path_to_class_def=distribution_definitions/saint_and_reward.py 
export distribution_class_name=SaintRewardMaximizer
export dir_to_output_data=data/saint_and_reward

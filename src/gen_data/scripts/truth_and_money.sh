#!/bin/bash
#SBATCH --job-name=truth_and_money
...
export path_to_class_def=distribution_definitions/truth_and_money.py 
export distribution_class_name=TruthMoney
export dir_to_output_data=data/truth_and_money

#!/bin/bash
#SBATCH --job-name=genie_and_fitness
...
export path_to_class_def=distribution_definitions/genie_and_fitness.py 
export distribution_class_name=GenieFitnessMaximizer
export dir_to_output_data=data/genie_and_fitness
source scl_source enable devtoolset-10

# mpirun --allow-run-as-root --oversubscribe -np 8 python gen_utils/generate_examples.py \

#!/bin/bash
#SBATCH --job-name=saint_and_money
...
export path_to_class_def=distribution_definitions/saint_and_money.py 
export distribution_class_name=SaintMoneyMaximizer
export dir_to_output_data=data/saint_and_money

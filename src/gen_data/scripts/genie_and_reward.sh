#!/bin/bash
#SBATCH --job-name=genie_and_reward
...
export path_to_class_def=distribution_definitions/genie_and_reward.py 
export distribution_class_name=GenieRewardMaximizer
export dir_to_output_data=data/genie_and_reward
